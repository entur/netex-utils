...
public class LegacyNetexIdUtils {
    ...
    // adapted from assertValidOfType
    public static boolean isValidOfType(String id, String expectedType) {
        assertValid(id);
        return Objects.equals(getType(id), expectedType);
    }
