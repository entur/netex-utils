...
public class NetexIdPredicateBenchmark {
    ...
    public long codespaceTypeNonValidate() {
        long count = 0;
        for (String id : IDS) {
            if (codespaceTypeNoValidate.test(id)) {
                count++;
            }
        }
        return count;
    ...
    @Benchmark
    public long codespaceTypeValidate() {
        long count = 0;
        for (String id : IDS) {
            if (codespaceTypeValidate.test(id)) {
                count++;
            }
        }
        return count;
    ...
    @Benchmark
    public long typeValidateLegacy() {
        long count = 0;
        for (String id : IDS) {
            if (LegacyNetexIdUtils.isValidOfType(id, "FareZone")) {
                count++;
            }
        }
        return count;
