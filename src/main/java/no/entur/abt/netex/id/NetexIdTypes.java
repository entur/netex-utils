...
public class NetexIdTypes {
	...
	public static class Predicates {
		...
		/**
		 * Composes, on every call, a fresh immutable map from every NeTEx id type constant declared in
		 * {@link NetexIdTypes} to its corresponding no-arg {@code isXxx()} {@link Predicate}, e.g.
		 * {@code NetexIdTypes.AUTHORITY -> } the same predicate returned by {@link NetexIdTypes#isAuthority()}.
		 */
		public static Map<String, Predicate<CharSequence>> asMap() {
			return Map.ofEntries(
				Map.entry(AVAILABILITY_CONDITION, AVAILABILITY_CONDITION_PREDICATE),
				Map.entry(TARIFF_ZONE, TARIFF_ZONE_PREDICATE),
				Map.entry(FARE_ZONE, FARE_ZONE_PREDICATE),
				Map.entry(GROUP_OF_LINES, GROUP_OF_LINES_PREDICATE),
				Map.entry(GROUP_OF_TARIFF_ZONES, GROUP_OF_TARIFF_ZONES_PREDICATE),
				Map.entry(GROUP_TICKET, GROUP_TICKET_PREDICATE),
				Map.entry(COMPANION_PROFILE, COMPANION_PROFILE_PREDICATE),
				Map.entry(COMMERCIAL_PROFILE, COMMERCIAL_PROFILE_PREDICATE),
				Map.entry(AUTHORITY, AUTHORITY_PREDICATE),
				Map.entry(OPERATOR, OPERATOR_PREDICATE),
				Map.entry(GENERAL_ORGANISATION, GENERAL_ORGANISATION_PREDICATE),
				Map.entry(CLASS_OF_USE, CLASS_OF_USE_PREDICATE),
				Map.entry(CUSTOMER, CUSTOMER_PREDICATE),
				Map.entry(CUSTOMER_ACCOUNT, CUSTOMER_ACCOUNT_PREDICATE),
				Map.entry(CUSTOMER_PURCHASE_PACKAGE, CUSTOMER_PURCHASE_PACKAGE_PREDICATE),
				Map.entry(CUSTOMER_PURCHASE_PACKAGE_ELEMENT, CUSTOMER_PURCHASE_PACKAGE_ELEMENT_PREDICATE),
				Map.entry(CUSTOMER_PURCHASE_PACKAGE_ELEMENT_ACCESS, CUSTOMER_PURCHASE_PACKAGE_ELEMENT_ACCESS_PREDICATE),
				Map.entry(CUSTOMER_PURCHASE_PARAMETER_ASSIGNMENT, CUSTOMER_PURCHASE_PARAMETER_ASSIGNMENT_PREDICATE),
				Map.entry(FARE_CONTRACT, FARE_CONTRACT_PREDICATE),
				Map.entry(FARE_DAY_TYPE, FARE_DAY_TYPE_PREDICATE),
				Map.entry(FARE_DEMAND_FACTOR, FARE_DEMAND_FACTOR_PREDICATE),
				Map.entry(FARE_PRODUCT, FARE_PRODUCT_PREDICATE),
				Map.entry(UIC_OPERATING_PERIOD, UIC_OPERATING_PERIOD_PREDICATE),
				Map.entry(FREQUENCY_OF_USE, FREQUENCY_OF_USE_PREDICATE),
				Map.entry(PREASSIGNED_FARE_PRODUCT, PREASSIGNED_FARE_PRODUCT_PREDICATE),
				Map.entry(SUPPLEMENT_PRODUCT, SUPPLEMENT_PRODUCT_PREDICATE),
				Map.entry(LINE, LINE_PREDICATE),
				Map.entry(ROUTE, ROUTE_PREDICATE),
				Map.entry(FLEXIBLE_LINE, FLEXIBLE_LINE_PREDICATE),
				Map.entry(USER_PROFILE, USER_PROFILE_PREDICATE),
				Map.entry(SERVICE_JOURNEY, SERVICE_JOURNEY_PREDICATE),
				Map.entry(DATED_SERVICE_JOURNEY, DATED_SERVICE_JOURNEY_PREDICATE),
				Map.entry(JOURNEY_PATTERN, JOURNEY_PATTERN_PREDICATE),
				Map.entry(NETWORK, NETWORK_PREDICATE),
				Map.entry(SCHEDULED_STOP_POINT, SCHEDULED_STOP_POINT_PREDICATE),
				Map.entry(STOP_POINT_IN_JOURNEY_PATTERN, STOP_POINT_IN_JOURNEY_PATTERN_PREDICATE),
				Map.entry(STOP_PLACE, STOP_PLACE_PREDICATE),
				Map.entry(QUAY, QUAY_PREDICATE),
				Map.entry(DISTANCE_MATRIX_ELEMENT, DISTANCE_MATRIX_ELEMENT_PREDICATE),
				Map.entry(DYNAMIC_DISTANCE_MATRIX_ELEMENT, DYNAMIC_DISTANCE_MATRIX_ELEMENT_PREDICATE),
				Map.entry(SALE_DISCOUNT_RIGHT, SALE_DISCOUNT_RIGHT_PREDICATE),
				Map.entry(SALES_PACKAGE, SALES_PACKAGE_PREDICATE),
				Map.entry(SALES_PACKAGE_ELEMENT, SALES_PACKAGE_ELEMENT_PREDICATE),
				Map.entry(SALES_TRANSACTION, SALES_TRANSACTION_PREDICATE),
				Map.entry(USAGE_DISCOUNT_RIGHT, USAGE_DISCOUNT_RIGHT_PREDICATE),
				Map.entry(CAPPED_DISCOUNT_RIGHT, CAPPED_DISCOUNT_RIGHT_PREDICATE),
				Map.entry(AMOUNT_OF_PRICE_UNIT_PRODUCT, AMOUNT_OF_PRICE_UNIT_PRODUCT_PREDICATE),
				Map.entry(USAGE_VALIDITY_PERIOD, USAGE_VALIDITY_PERIOD_PREDICATE),
				Map.entry(VALID_BETWEEN, VALID_BETWEEN_PREDICATE),
				Map.entry(VALID_DURING, VALID_DURING_PREDICATE),
				Map.entry(DAY_TYPE, DAY_TYPE_PREDICATE),
				Map.entry(THIRD_PARTY_PRODUCT, THIRD_PARTY_PRODUCT_PREDICATE),
				Map.entry(TIME_INTERVAL, TIME_INTERVAL_PREDICATE),
				Map.entry(TIMEBAND, TIMEBAND_PREDICATE),
				Map.entry(TOPOGRAPHIC_PLACE, TOPOGRAPHIC_PLACE_PREDICATE),
				Map.entry(TRANSFERABILITY, TRANSFERABILITY_PREDICATE),
				Map.entry(TYPE_OF_ACCESS_RIGHT_ASSIGNMENT, TYPE_OF_ACCESS_RIGHT_ASSIGNMENT_PREDICATE),
				Map.entry(TYPE_OF_FARE_CONTRACT, TYPE_OF_FARE_CONTRACT_PREDICATE),
				Map.entry(TYPE_OF_CUSTOMER_ACCOUNT, TYPE_OF_CUSTOMER_ACCOUNT_PREDICATE),
				Map.entry(TYPE_OF_RESPONSIBILITY_ROLE, TYPE_OF_RESPONSIBILITY_ROLE_PREDICATE),
				Map.entry(TYPE_OF_TRAVEL_DOCUMENT, TYPE_OF_TRAVEL_DOCUMENT_PREDICATE),
				Map.entry(TYPE_OF_CONCESSION, TYPE_OF_CONCESSION_PREDICATE),
				Map.entry(TYPE_OF_FARE_PRODUCT, TYPE_OF_FARE_PRODUCT_PREDICATE),
				Map.entry(TYPE_OF_USAGE_PARAMETER, TYPE_OF_USAGE_PARAMETER_PREDICATE),
				Map.entry(TYPE_OF_VALUE, TYPE_OF_VALUE_PREDICATE),
				Map.entry(SALES_OFFER_PACKAGE, SALES_OFFER_PACKAGE_PREDICATE),
				Map.entry(SALES_OFFER_PACKAGE_ELEMENT, SALES_OFFER_PACKAGE_ELEMENT_PREDICATE),
				Map.entry(SERVICE_LINK, SERVICE_LINK_PREDICATE),
				Map.entry(SERVICE_LINK_IN_JOURNEY_PATTERN, SERVICE_LINK_IN_JOURNEY_PATTERN_PREDICATE),
				Map.entry(LINK_SEQUENCE_PROJECTION, LINK_SEQUENCE_PROJECTION_PREDICATE),
				Map.entry(VALIDABLE_ELEMENT, VALIDABLE_ELEMENT_PREDICATE),
				Map.entry(NOD_STOP_PLACE_MAPPING, NOD_STOP_PLACE_MAPPING_PREDICATE),
				Map.entry(FARE_ZONE_MAPPING, FARE_ZONE_MAPPING_PREDICATE),
				Map.entry(TARIFF_CODE_MAPPING, TARIFF_CODE_MAPPING_PREDICATE),
				Map.entry(FARE_PRICE, FARE_PRICE_PREDICATE),
				Map.entry(NOTICE_ASSIGNMENT, NOTICE_ASSIGNMENT_PREDICATE),
				Map.entry(PRICE_UNIT, PRICE_UNIT_PREDICATE),
				Map.entry(REVERTING, REVERTING_PREDICATE),
				Map.entry(CODESPACE, CODESPACE_PREDICATE),
				Map.entry(DISTRIBUTION_CHANNEL, DISTRIBUTION_CHANNEL_PREDICATE),
				Map.entry(FULFILMENT_METHOD, FULFILMENT_METHOD_PREDICATE),
				Map.entry(PASSENGER_SEAT, PASSENGER_SEAT_PREDICATE),
				Map.entry(INTERCHANGING, INTERCHANGING_PREDICATE),
				Map.entry(GEOGRAPHICAL_INTERVAL, GEOGRAPHICAL_INTERVAL_PREDICATE),
				Map.entry(FARE_STRUCTURE_ELEMENT, FARE_STRUCTURE_ELEMENT_PREDICATE),
				Map.entry(LUGGAGE_ALLOWANCE, LUGGAGE_ALLOWANCE_PREDICATE),
				Map.entry(GEOGRAPHICAL_STRUCTURE_FACTOR, GEOGRAPHICAL_STRUCTURE_FACTOR_PREDICATE),
				Map.entry(CHARGING_MOMENT, CHARGING_MOMENT_PREDICATE),
				Map.entry(ENTITLEMENT_PRODUCT, ENTITLEMENT_PRODUCT_PREDICATE),
				Map.entry(ENTITLEMENT_REQUIRED, ENTITLEMENT_REQUIRED_PREDICATE),
				Map.entry(CHARGING_POLICY, CHARGING_POLICY_PREDICATE),
				Map.entry(ENTITLEMENT_GIVEN, ENTITLEMENT_GIVEN_PREDICATE),
				Map.entry(EXCHANGING, EXCHANGING_PREDICATE),
				Map.entry(FARE_TABLE, FARE_TABLE_PREDICATE),
				Map.entry(GENERIC_PARAMETER_ASSIGNMENT, GENERIC_PARAMETER_ASSIGNMENT_PREDICATE),
				Map.entry(PENALTY_POLICY, PENALTY_POLICY_PREDICATE),
				Map.entry(PURCHASE_WINDOW, PURCHASE_WINDOW_PREDICATE),
				Map.entry(REFUNDING, REFUNDING_PREDICATE),
				Map.entry(RESERVING, RESERVING_PREDICATE),
				Map.entry(ROUND_TRIP, ROUND_TRIP_PREDICATE),
				Map.entry(TARIFF, TARIFF_PREDICATE),
				Map.entry(PARKING, PARKING_PREDICATE),
				Map.entry(CANCELLING, CANCELLING_PREDICATE),
				Map.entry(RESELLING, RESELLING_PREDICATE),
				Map.entry(REPLACING, REPLACING_PREDICATE),
				Map.entry(SUBSCRIBING, SUBSCRIBING_PREDICATE),
				Map.entry(ELIGIBILITY_CHANGE_POLICY, ELIGIBILITY_CHANGE_POLICY_PREDICATE),
				Map.entry(ROUTING, ROUTING_PREDICATE),
				Map.entry(STEP_LIMIT, STEP_LIMIT_PREDICATE),
				Map.entry(SUSPENDING, SUSPENDING_PREDICATE),
				Map.entry(MINIMUM_STAY, MINIMUM_STAY_PREDICATE),
				Map.entry(SALES_OFFER_PACKAGE_ENTITLEMENT_GIVEN, SALES_OFFER_PACKAGE_ENTITLEMENT_GIVEN_PREDICATE),
				Map.entry(SALES_OFFER_PACKAGE_ENTITLEMENT_REQUIRED, SALES_OFFER_PACKAGE_ENTITLEMENT_REQUIRED_PREDICATE),
				Map.entry(FARE_SECTION, FARE_SECTION_PREDICATE),
				Map.entry(VERSION, VERSION_PREDICATE),
				Map.entry(SECURITY_POLICY, SECURITY_POLICY_PREDICATE),
				Map.entry(ONBOARD_VALIDITY, ONBOARD_VALIDITY_PREDICATE),
				Map.entry(VALIDITY_CONDITION, VALIDITY_CONDITION_PREDICATE),
				Map.entry(OPERATING_DAY, OPERATING_DAY_PREDICATE),
				Map.entry(RESPONSIBILITY_SET, RESPONSIBILITY_SET_PREDICATE),
				Map.entry(RESPONSIBILITY_ROLE_ASSIGNMENT, RESPONSIBILITY_ROLE_ASSIGNMENT_PREDICATE)
			);
		}
